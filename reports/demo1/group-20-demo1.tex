...
To ensure that TurtleBot is moving the correct distances we are using feedback from the odometer to determine how far the TurtleBot has travelled.
To gather odometer feedback we are using the ROS data feeds, as these are already implemented for the TurtleBot and fairly accurate.
